...
*/
$sql1 = "select * from studentinfo where email = '$verify'";
				...
				<div id="header">
					...
					<!-- Nav -->
						<nav id="nav">
							<ul>
								<?php
								echo "<li class='current'><a href='studentPage.php?email='".$verify."'>Home</a></li>";
								echo "<li><a href='updateInformation.php?email=".$verify."'>Update Profile</a></li>";
